...
func TestGCP_CollectMetrics(t *testing.T) {
	tests := map[string]struct {
		...
		"bubble-up single collector error": {
			...
			expectedMetrics: []*utils.MetricResult{
				{
					FqName:     "cloudcost_exporter_gcp_collector_last_scrape_error",
					Labels:     utils.LabelMap{"collector": "test"},
					Value:      0,
					MetricType: prometheus.GaugeValue,
				},
				{
					FqName:     "cloudcost_exporter_gcp_collector_last_scrape_duration_seconds",
					Labels:     utils.LabelMap{"collector": "test"},
					Value:      0,
					MetricType: prometheus.GaugeValue,
				},
				{
					FqName:     "cloudcost_exporter_gcp_last_scrape_error",
					Labels:     utils.LabelMap{},
					Value:      1,
					MetricType: prometheus.GaugeValue,
				},
				{
					FqName:     "cloudcost_exporter_gcp_last_scrape_duration_seconds",
					Labels:     utils.LabelMap{},
					Value:      1,
					MetricType: prometheus.GaugeValue,
				},
