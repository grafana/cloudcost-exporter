...
type AzureClient interface {
	...
	// Event Hubs
	ListEventHubNamespaces(context.Context) ([]*armeventhub.EHNamespace, error)
	QueryResourceMetrics(context.Context, string, string, []string, []string, *azmetrics.QueryResourcesOptions) (azmetrics.QueryResourcesResponse, error)
