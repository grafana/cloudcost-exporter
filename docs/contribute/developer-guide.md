...
Releases are automated! When merging a PR, add a release label (`release:major`, `release:minor`, or `release:patch`) to automatically create a new release. See the [release process documentation](./releases.md#automated-releases-recommended) for details.
