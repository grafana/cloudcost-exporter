...
func (mr *MockELBv2MockRecorder) DescribeLoadBalancers(ctx, params interface{}, optFns ...interface{}) *gomock.Call {
...
func (mr *MockELBv2MockRecorder) DescribeTargetGroups(ctx, params interface{}, optFns ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, params}, optFns...)
